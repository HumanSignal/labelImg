...
# 2. Saving Image Files using Google Cloud
-------------------------------------
## Precursor: Image Training
...
1. Get the latest version of master for this repo on your computer.
...
14. Tell Joel and Arvind that you have trained and label every image. They'll retrieve the images from the computer.
...
# 3. Original LabelImg README
--------------------------

![](https://img.shields.io/pypi/v/labelimg.svg) ![](https://img.shields.io/travis/tzutalin/labelImg.svg)
