...
then execute "pyrcc5 resources.qrc -o resources.py" in Git Bash in the root directory
and execute "pyrcc5 ../resources.qrc -o resources.py" in Git Bash in the libs directory
"""
import re
import os
import sys
